Unsymbolicated crashes, collected from the same app (version) on the same ARM64 device running iOS 13.6 / iOS 13.6.1, are stored in `UnsymbolicatedCrashes` folder
